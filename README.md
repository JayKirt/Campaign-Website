...
<h4> <ins> To do: </ins> </h4>
  ...
  <li> About us page.</li>
  <li> Character page:<br> Images displaying in grid pushed to the left ✔️ <br> Descriptions on right hand side of image. <br> Image is clickable and redirects to a page about that character</li>
